...
The enigma machine is an analog cipher device invented by German engineer Arthur Scherbius in 1918. It is most famous for being used by Nazi Germany during WII to encrypt secret messages within the millitary and classified information. The enigma was broken by the Polish which decrypted enigma traffic on a continuous basis before being invaded by the Germans 1939. The British (and the French) continued and reproduced the work of the Polish by building the Bombe machine at Bletchley Park to decipher enigma messages, effectively shorting the war by years.
